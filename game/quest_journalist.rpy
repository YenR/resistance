...
# ==============================================================================
    ...
    $ risk_dossier, tip_dossier = calc_choice_risk(
        base=40,
        suspicion=suspicion,
        pc=pc,
        spotlight="language", 
    ...
    call screen risk_assessment_menu_2options(
        ...
        option1="Present the file on the riots.", option1tt="{}% Chance of Failure\n{}".format(risk_dossier, tip_dossier),
        option2="Say it was nothing. Go solo.", option2tt="0% Chance of Failure"
    )
...
#---
    ...
    if chosen_approach == "Frame it as a major scoop.":
...
# ==============================================================================
    ...
    $ risk_dossier = max(5, min(85, risk_dossier))
    $ current_outcome = perform_roll(risk_dossier)
...
label quest_journalist_go_solo:
    ...
    "If the paper won't sanction the investigation, then you'll just have to do it on your own."
    $ institutional_cover = "None"
...
$ risk_record, tip_record = calc_choice_risk(
        base=40,
        suspicion=suspicion,
        pc=pc,
        spotlight=None, 
...
call screen risk_assessment_menu_2options(
        ...
        option1="Get close with a hidden mic.", option1tt="{}% Chance of Failure\n{}".format(risk_record, tip_record),
        option2="Lip read from a distance.", option2tt="0% Chance of Failure"
    )
...
label quest_journalist_caught:
    ...
    "You are thrown out. You aren't arrested, but your cover is blown."
